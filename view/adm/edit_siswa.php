...
if ($get_sw = $conn->query($sql_sw)->fetch_assoc()) {
  ...
  <form class="form-horizontal" role="form" style="width:80%" onSubmit="return validasi()" name="formulir" method="post"
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="number" value="<?php echo $nis_user; ?>" class="form-control" name="nis" placeholder="Masukan NIS"
          required>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" value="<?php echo $name_user; ?>" class="form-control" name="nama"
